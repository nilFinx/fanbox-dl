...
var userAgentFlag = &cli.StringFlag{
	...
	Value: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.7680.166 Safari/537.36",
}
...
var app = &cli.App{
	...
	Action: func(c *cli.Context) error {
		...
		tlsTransp, err := tlsclient.NewTransportWithOptions(tls_client.NewNoopLogger(), tls_client.WithClientProfile(profiles.Chrome_146))
		if err != nil {
